...
export default function AudioPlayerBar({ audioEl, activeSong, onNext, onPrev, onSeek, onSkip, onSongClick }) {
  ...
  return (
    <div className="w-full flex items-center justify-between p-4 bg-neutral-900 text-white gap-4">
      <div onClick={onSongClick} className="flex items-center gap-4 w-1/4 cursor-pointer">
        {activeSong.imgUrl ? (
