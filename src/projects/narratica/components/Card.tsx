...
const Card = ({ book }: Props) => {
  ...
  return (
    <section className='rounded-lg bg-narratica-gray-light w-full shadow-lg hover:bg-narratica-gray-dark cursor-pointer transition-colors'>
      <section className='relative w-full aspect-square'>
        {secureImageUrl ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-narratica-gray-dark rounded-md">
            <svg className="w-1/2 h-1/2 text-narratica-text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
      ...
      <section className='p-3'>
        <h2 className='text-narratica-text-primary text-sm font-bold truncate' title={book.title}>
          {book.title}
        </h2>
        <h3 className='text-narratica-text-secondary text-xs truncate' title={book.authorName}>
          {book.authorName}
        </h3>
      </section>
    </section>
